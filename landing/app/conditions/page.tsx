...
export const metadata: Metadata = {
  ...
  description: "Les conditions essentielles d’utilisation de DealUp AI.",
...
export default function TermsPage() {
  return (
    <InformationPage
      eyebrow="Conditions"
      intro="Les règles essentielles pour utiliser DealUp AI et comprendre le rôle de ses analyses."
      title="Conditions d’utilisation."
    ...
    >
      <section>
        <h2>1. Définitions</h2>
        <p>
          « Application » désigne l’application mobile DealUp AI. « Service » désigne l’Application, le site et les
      ...
      <section>
        <h2>2. Acceptation</h2>
        <p>
          En créant un compte ou en utilisant DealUp AI, tu acceptes ces Conditions et la Politique de confidentialité.
      ...
      <section>
        <h2>3. Le Service</h2>
        <p>
          DealUp AI aide à évaluer certaines annonces Leboncoin d’appareils d’occasion compatibles. L’Application fournit une
          estimation, des points de vigilance, des questions à poser et une checklist pour préparer ta décision.
        </p>
        <p>
          DealUp AI ne certifie ni l’authenticité, ni la propriété, ni l’absence de vol, ni l’état réel d’un appareil.
      ...
      <section>
        <h2>4. Compte</h2>
        <p>
          Tu dois fournir des informations exactes, protéger l’accès à ton compte et utiliser DealUp AI uniquement à des
      ...
      <section>
        ...
        <p>
          Tu conserves tes droits sur ton Contenu utilisateur. Tu accordes à DealUp AI une autorisation limitée,
      ...
      <section>
        ...
        <p>Il est interdit d’utiliser DealUp AI pour :</p>
        <ul>
      ...
      <section>
        ...
        <p>
          ...
          s’appliquer à leur utilisation. DealUp AI ne contrôle pas leurs interruptions ou leurs décisions.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Le Service, la marque, l’interface et les contenus fournis par DealUp AI restent la propriété de DealUp AI ou de
      ...
      <section>
        ...
        <p>
          Le Service est fourni selon sa disponibilité. DealUp AI peut évoluer, être temporairement indisponible ou
      ...
      <section>
        ...
        <p>
          DealUp AI peut suspendre ou fermer un compte en cas de fraude, d’abus, de risque de sécurité ou de violation de
      ...
      <section>
        ...
        <p>
          Les résultats automatisés peuvent être incomplets ou inexacts. DealUp AI n’est pas partie à la transaction entre
