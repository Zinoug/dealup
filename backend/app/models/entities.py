...
class Analysis(Base):
    ...
    source_url: Mapped[str] = mapped_column(Text)
    external_listing_id: Mapped[str | None] = mapped_column(String(128), index=True)
    purchase_mode: Mapped[PurchaseMode] = mapped_column(enum_type(PurchaseMode))
    seller_contacted: Mapped[bool] = mapped_column(Boolean, default=False)
    seller_reply_text: Mapped[str | None] = mapped_column(Text)
    seller_media: Mapped[list[dict[str, Any]]] = mapped_column(
        json_type(), default=list
    )
    listing_payload: Mapped[dict[str, Any] | None] = mapped_column(json_type())
    normalized_listing: Mapped[dict[str, Any] | None] = mapped_column(json_type())
    device_category: Mapped[str | None] = mapped_column(String(32), index=True)
    device_profile: Mapped[dict[str, Any] | None] = mapped_column(json_type())
    parent_result: Mapped[dict[str, Any] | None] = mapped_column(json_type())
    candidate_result: Mapped[dict[str, Any] | None] = mapped_column(json_type())
    result: Mapped[dict[str, Any] | None] = mapped_column(json_type())
    provider_metadata: Mapped[dict[str, Any] | None] = mapped_column(json_type())
    template_id: Mapped[str | None] = mapped_column(String(32), index=True)
    model_id: Mapped[str | None] = mapped_column(String(128))
    model_config: Mapped[dict[str, Any] | None] = mapped_column(json_type())
    prompt_version: Mapped[str] = mapped_column(String(32), default="2.0")
    schema_version: Mapped[str] = mapped_column(String(32), default="2.0")
    taxonomy_version: Mapped[str] = mapped_column(String(32), default="1.0")
    scoring_version: Mapped[str] = mapped_column(String(32), default="1.0")
    checklist_version: Mapped[str] = mapped_column(String(32), default="1.0")
    device_catalog_version: Mapped[str] = mapped_column(String(32), default="1.0")
    ...
    billed_cost_microusd: Mapped[int | None] = mapped_column(BigInteger)
    piloterr_cost_microeur: Mapped[int | None] = mapped_column(BigInteger)
    provider_pricing_version: Mapped[str | None] = mapped_column(String(32))
